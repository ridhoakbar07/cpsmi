        ...
        <div>
                ...
                <div>
                    <div
                        ...
                        <div class="flex items-center mb-6">
                            <div
                                class="w-16 h-16 bg-gray-700 text-blue-200 dark:bg-blue-300 dark:text-gray-900 rounded-2xl flex items-center justify-center mr-4 group-hover:scale-110 transition-transform duration-300">
            ...
            <div
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-2 md:gap-4 xl:gap-6">
                    <!-- Kecepatan -->
                    <div class="flex flex-col items-center group text-center my-2 hover:animate-pulse transition-all duration-300">
                        <div
                            class="w-16 h-16 bg-gray-700 text-blue-200 dark:bg-blue-300 dark:text-gray-900 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 mb-2">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
