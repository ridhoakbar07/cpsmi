<footer class="relative bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 text-white">
        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-4">
            ...
            <div class="lg:col-span-2">
                <div class="flex items-center mb-6">
                    ...
                    <div>
                        <h3 class="text-2xl font-bold text-white">PT. Inayah Bintang Borneo</h3>
                        <p class="text-blue-200">Ekspedisi & Logistik Terpercaya</p>
                    </div>
                </div>
                ...
                <div class="space-y-3">
                    <div class="flex items-center">
                        ...
                        <span class="text-gray-300">Kalimantan Tengah, Indonesia</span>
                    </div>
                    <div class="flex items-center">
                        <svg class="w-5 h-5 text-blue-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <span class="text-gray-300">+62 123 4567 8900</span>
                    </div>
                    <div class="flex items-center">
                        <svg class="w-5 h-5 text-blue-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <span class="text-gray-300">info@cpsmi.co.id</span>
                    </div>
                </div>
            </div>
            ...
            <!-- Quick Links -->
            <div>
                <h3 class="mb-6 text-sm font-semibold text-white uppercase tracking-wider">Navigasi</h3>
                <ul class="space-y-3">
                    <li>
                        <a href="/"
            ...
            <!-- Services -->
            <div>
                <h3 class="mb-6 text-sm font-semibold text-white uppercase tracking-wider">Layanan</h3>
                <ul class="space-y-3">
                    <li>
                        <a href="#"
                            class="text-gray-300 hover:text-blue-400 transition-colors duration-200 flex items-center group">
        ...
        <div class="border-t border-white/10 mt-12 pt-8">
            <div class="flex flex-col md:flex-row justify-between items-center">
                ...
                <div class="text-center md:text-left mb-4 md:mb-0">
                    <span class="text-gray-300">© 2025
                        <a href="/" class="hover:text-blue-400 transition-colors duration-200 font-semibold">PT. Inayah
                            Bintang Borneo</a>.
                        Seluruh hak cipta dilindungi.
                    </span>
                    <div class="mt-2">
                        <a href="#"
                            class="text-gray-400 hover:text-blue-400 transition-colors duration-200 text-sm mr-4">Kebijakan
                            Privasi</a>
                        <a href="#"
                            class="text-gray-400 hover:text-blue-400 transition-colors duration-200 text-sm">Syarat &
                            Ketentuan</a>
                    </div>
                </div>
                ...
                <div class="flex space-x-4">
                    <a href="#"
                        ...
                        <svg class="w-5 h-5 group-hover:scale-110 transition-transform duration-300" fill="currentColor"
                            viewBox="0 0 24 24">
                            <path
