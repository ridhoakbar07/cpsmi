<header id="main-navbar"
  class="sticky top-0 z-50 bg-transparent dark:bg-gray-900 backdrop-blur-xl transition-all duration-300">
      ...
      <ul class="flex flex-col mt-4 font-semibold lg:flex-row lg:space-x-8 lg:mt-0">
        ...
        <li>
          <a href="{{route('visi-misi')}}"
            class="block py-2 text-gray-900 dark:text-blue-100 tracking-tight hover:animate-[pulse_1s_ease-in-out] hover:font-bold hover:text-blue-900 dark:hover:text-blue-200 transition delay-100 duration-100 ease-in-out hover:scale-110">Visi
            misi</a>
        </li>
        <li>
