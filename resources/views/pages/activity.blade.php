<x-layouts.app :title="'Aktivitas | PT. Inayah Bintang Borneo'">
        ...
        <div class="container w-full mx-auto rounded-3xl overflow-hidden my-12">
            ...
            <div class="isolate px-6 py-24 sm:py-32 lg:px-8">
                ...
                <div class="mx-auto max-w-2xl text-center mb-16">
                    <h2 class="text-4xl font-semibold tracking-tight text-balance text-gray-900 dark:text-white sm:text-5xl">
                        Aktivitas Perusahaan
                    </h2>
                    <p class="mt-2 text-lg/8 text-gray-700 dark:text-gray-300">
                        Dokumentasi kegiatan dan aktivitas PT. Inayah Bintang Borneo dalam melayani kebutuhan logistik Anda
                    </p>
                </div>
                ...
                <div class="mx-auto max-w-7xl">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 h-auto">
                        ...
                        <div class="col-span-1 md:col-span-2 lg:col-span-2 row-span-2 relative group overflow-hidden rounded-3xl bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-900 shadow-lg hover:shadow-xl transition-all duration-300">
                            ...
                            <div class="absolute bottom-6 left-6 text-white">
                                ...
                                <p class="text-sm opacity-90">Fasilitas penyimpanan modern dengan sistem manajemen yang efisien</p>
                            </div>
                        </div>

                        <!-- Medium Image 1 - Loading Process -->
                        <div class="col-span-1 lg:col-span-1 relative group overflow-hidden rounded-3xl bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-900 shadow-lg hover:shadow-xl transition-all duration-300">
                            <div class="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent"></div>
                        ...
                        <!-- Small Images Row -->
                        <div class="col-span-1 md:col-span-1 relative group overflow-hidden rounded-3xl bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-900 shadow-lg hover:shadow-xl transition-all duration-300">
                            <div class="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent"></div>
                        ...
                        <div class="col-span-1 md:col-span-2 lg:col-span-2 relative group overflow-hidden rounded-3xl bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-900 shadow-lg hover:shadow-xl transition-all duration-300">
                            <div class="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent"></div>
                            ...
                            <div class="absolute bottom-6 left-6 text-white">
                                ...
                                <p class="text-sm opacity-90">Layanan port to door dengan jaringan pelabuhan terpercaya</p>
                            </div>
                        </div>

                        <!-- Vertical Image -->
                        <div class="col-span-1 md:col-span-1 lg:col-span-1 row-span-2 relative group overflow-hidden rounded-3xl bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-900 shadow-lg hover:shadow-xl transition-all duration-300">
                            <div class="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent"></div>
                ...
                <div class="mx-auto max-w-7xl mt-20">
                    <div class="grid grid-cols-2 lg:grid-cols-4 gap-8">
                        <div class="text-center p-6 rounded-2xl bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm shadow-lg">
                ...
                <div class="mx-auto max-w-4xl mt-20 text-center">
                    <div class="bg-gradient-to-r from-indigo-600 to-blue-600 rounded-3xl p-8 shadow-xl">
                        ...
                        <p class="text-blue-100 mb-6">Hubungi kami untuk konsultasi dan penawaran terbaik sesuai kebutuhan bisnis Anda</p>
                        <a href="/contact-us" class="inline-flex items-center px-6 py-3 bg-white text-indigo-600 font-semibold rounded-lg hover:bg-gray-50 transition-colors duration-200">
